...
const validContext: ExternalSupportingPersistenceContext = {
  rawClaim: { id: "raw-1", claimType: "subjective_observation", verificationState: "source_confirmed", supersededByCount: 0,
    ...
    identity: { id: "identity-1", certainty: "equipment_model_match", equipmentId: "equipment-1", manufacturerMatches: true, modelMatches: true, modelYearMatches: true, certificationMatches: true, productFamilyMatches: true, dropMatches: true } },
  normalizedClaim: { id: "normalized-1", rawClaimId: "raw-1", verificationState: "source_confirmed" },
  dependencyAssessment: { id: "dependency-1", claimId: "raw-1", dependencyType: "independent_observation", independenceGroupId: "reviewer-lineage-1", reviewedState: "reviewed_accepted", reviewerType: "human", reviewerReference: "dependency-reviewer-1", supersededByCount: 0 },
...
for (const [name, change] of [
  ...
  ["anonymous independence review", { dependencyAssessment: { ...validContext.dependencyAssessment, reviewerReference: "" } }],
  ["non-human independence review", { dependencyAssessment: { ...validContext.dependencyAssessment, reviewerType: "system" } }],
  ...
  ["invalid qualification contract", { qualification: { ...validContext.qualification, contractVersion: "0.9" } }],
  ["invalid construct mapping version", { constructRelationship: { ...validContext.constructRelationship, mappingVersion: "0.9" } }],
  ["invalid construct policy version", { constructRelationship: { ...validContext.constructRelationship, policyVersion: "0.9" } }],
  ["invalid construct role", { constructRelationship: { ...validContext.constructRelationship, role: "candidate_only" } }],
  ["invalid construct review state", { constructRelationship: { ...validContext.constructRelationship, reviewState: "review_pending" } }],
